...
@Entity("language_label_1", { schema: "amygo1" })
export class LanguageLabel_1 {
  ...
  @ManyToOne(
    () => AppScreenMaster,
    (appScreenMaster) => appScreenMaster.languageLabels1,
  )
  ...
  @ManyToOne(
    () => LanguageMaster,
    (languageMaster) => languageMaster.languageLabels1,
  )
