...
import { HelpDetailCategories } from "../../help-detail-categories/entities/help-detail-category.entity";
...
export class HelpDetail {
  ...
  @ManyToOne(
    () => HelpDetailCategories,
    (helpDetailCategory) => helpDetailCategory.helpDetails,
  )
  @JoinColumn({
